...
/*                runOnUiThread(new Runnable() {
            ...
            try {
                ...
                if(!userId.equals(String.valueOf(SignInActivity.guser_id))) {
                    ...
                    if (type.equals(String.valueOf(DrawingObject.DrawingType.FREE))) {
                        ...
                        final boolean isErase = data.getBoolean("isErase");
                        mDrawView.setPaintErase(obj.getPaint(),isErase);
    ...
    private Emitter.Listener onEventUndo = new Emitter.Listener() {
        ...
        public void call(final Object... args) {
            ...
            try {
                ...
                final String userId = data.getString("user_id");
                Log.d("onEventUndo", "userId = " + userId);

                if(!userId.equals(String.valueOf(SignInActivity.guser_id))) {
                    final String timestamp = data.getString("timestamp");
                    Log.d("onEventUndo", "timestamp =" + timestamp);
        ...
        public void call(final Object... args) {
            ...
            try {
                ...
                if(!userId.equals(String.valueOf(SignInActivity.guser_id)))
                {
                    ...
                    final float localratio = (float) data.getDouble("localratio");
                    Log.d("onEventDraw", "localratio=" + localratio);
    ...
    private void switchToEraseMode() {
        final Dialog brushDialog = new Dialog(this);
        brushDialog.setTitle("Set Eraser size:");
        brushDialog.setContentView(R.layout.brush_chooser);
